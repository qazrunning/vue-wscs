<template>
	<div>
		...
		<section class="bbs_info" v-infinite-scroll="getMoocs" infinite-scroll-distance="7" infinite-scroll-disabled="loading">
			<div class="bbs_info_list" v-for="(a,index) in news">
				...
				<div class="info_txt">
					<a @click="goDetail([a.id,a.title])" v-html='`<p><font><font v-text="a.title">
